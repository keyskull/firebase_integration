...
class Article extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //routeName = title.replaceAll(exp, '-');
    //print (routeName);
    //path = path.split('/').last;
    return
      UniversalSingleChildScrollView(child: contents[path]!);
            ...
            children: [
              FittedBox(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage('https://miro.medium.com/fit/c/56/56/1*HQTxFkIf5fymNTatLc0qjA.jpeg'),
                ),
              ),
              SizedBox(width: 10,),
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(text: 'Kaki Okumura', style: TextStyle(
                      color: Colors.green,
                      fontSize: 14,
                    ),),
                    TextSpan(text: '    Nov 6, 2020·4 min read', style: TextStyle(
                      color: Colors.black,
                      fontSize: 14,
                    ),),
                  ],
            ...
            children: [
              FittedBox(
                ...
                child: CircleAvatar(
                  radius: 10,
                  backgroundColor: Colors.lightBlue,
                  backgroundImage: NetworkImage('https://miro.medium.com/fit/c/96/96/1*be9NhtCEZu-AB_zt2J46dg.jpeg'),
                ),
              ),
              SizedBox(width: 10,),
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(text: 'inc. magazine', style: TextStyle(
                      color: Colors.green,
                      fontSize: 14,
                    ),),
                    TextSpan(text: '    Dec 25, 2020 · 3 min read', style: TextStyle(
                      color: Colors.black,
                      fontSize: 14,
                    ),),
                  ],
            ...
            children: [
              FittedBox(
                ...
                child: CircleAvatar(
                  radius: 10,
                  backgroundColor: Colors.lightBlue,
                  backgroundImage: NetworkImage('https://miro.medium.com/fit/c/96/96/1*IMgPKmEYKITsEEZeW2jipw.gif'),
                ),
              ),
              SizedBox(width: 10,),
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(text: 'Ben Kageyama', style: TextStyle(
                      color: Colors.green,
                      fontSize: 14,
                    ),),
                    TextSpan(text: '    Jan 4·3 min read', style: TextStyle(
                      color: Colors.black,
                      fontSize: 14,
                    ),),
                  ],
...
var contents = {
  'How-Japanese-People-Stay-Fit-for-Life-Without-Ever-Visiting-a-Gym': Content1(),
